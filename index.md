...
(These embeddings have lots of other intersting properties, besides proximity. For example, directions in the embedding space seems to have semantic meaning. As a consequence, simple analogies can be solved using equations like king - man + woman ~= queen. For more on word embeddings, see my post [Deep Learning, NLP, and Representations](../2014-07-NLP-RNNs-Representations/).) TODO: Rewrite this paragraph
...
TODO: Note that wikipedia categories are sometimes much broader than one would expect. For example, nearly every human is included in the category *applied ethics*
